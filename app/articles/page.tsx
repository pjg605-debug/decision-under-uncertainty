  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto max-w-6xl px-4 pb-12 pt-12 sm:pt-20">
        <p className="eyebrow">Behavioral decision review</p>
        <h1 className="mt-4 max-w-3xl text-balance text-4xl font-semibold tracking-[-.04em] sm:text-6xl">
          돈과 감정이 함께 움직일 때,<br />판단을 연구하는 읽을거리
        </h1>
        <p className="mt-6 max-w-2xl text-base leading-8 text-muted-foreground">
          행동경제학과 행동금융학의 이론, 실제 실험 설계, 자료의 해석 한계를 거래·소비의 장면과 연결합니다. 정답을 지시하기보다 판단이 만들어지는 구조를 살펴봅니다.
        </p>
      </section>
            ...
            {articles.map((article, index) => (
              ...
              >
                ...
                <div className="mt-6 flex items-center justify-between">
                  <span className="text-xs text-muted-foreground">연구 해설 · 생각 실험</span>
